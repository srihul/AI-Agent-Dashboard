...
4. If you have other environment variables, make sure to add them to the .env file.
...
1. Google Sheets API Key: Obtain it from the Google Developer Console and add it to the .env file.
2. Other API keys can be added to the .env file in the same format:
   .env
